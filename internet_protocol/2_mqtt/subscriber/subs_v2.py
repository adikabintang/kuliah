# example: https://github.com/eclipse/paho.mqtt.python/blob/master/examples/client_sub.py
...
time.sleep(3)
conn = sqlite3.connect('/sub/output_db/ip_mqtt_sensor.db')
sqlc = conn.cursor()
...
mqttc.on_log = on_log
mqttc.connect("mosquitto", 8883, 60)
#mqttc.subscribe("#", 0)
